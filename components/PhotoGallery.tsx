        ...
        <div class="h-full w-full flex flex-col  m-auto p-auto ">
              ...
              >
                ...
                >
                    ...
                    return (<div class="inline-block px-4">
                        <div
                          class="w-screen sm:w-80 h-full max-w-xs overflow-hidden rounded-lg hover:shadow-xl transition-shadow duration-300 ease-in-out"
                        >
                            <img
                              src={item}
